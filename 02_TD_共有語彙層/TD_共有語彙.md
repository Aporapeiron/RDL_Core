...
本文書は、関係力学言語（RDL）の全層（T0 基盤層、T1 SILN操作層、T2 代謝機構層、T3 応用層）で共通して使用される**記号・基底量・中核概念・自然言語対応・補助表記**を定義する辞書（DICT）である。

T-D は語彙の最小定義と身分を保持する。具体的な数式・更新則・標準動態モデルは T0 SPEC に属し、本辞書では必要な場合のみ**標準表記・参照例**として区別して示す。
