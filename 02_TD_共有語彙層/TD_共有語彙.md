...
本文書および RDL が提示する記号群（$B, M_B, \xi, EFP, F, E, H, \theta$ 等）は、**「世界そのものの絶対的真理」や「客観的実体の名辞」として措定されたものではない**。

現実の世界は、大気圧、重力、熱交換、電磁場、社会規範、他者の存在など、無数の相互作用が全方位から拮抗し続ける「連続した高圧の海」である。そこから、思考・認識・計算・操作を破綻させずに前に進めるために、観測者が有限なハサミ（有限境界 $B$）を入れて切り分けた**「実用上きわめて便利な境界の引き方の提示（道具箱）」**にすぎない。

たとえば `EFP` という粒子やパケットが外界に単体で飛来しているわけではない。全方位の相互作用の中から、操作の便宜上切り出された方向付き断面を `EFP` と呼んでいる。

したがって、**RDL 語彙自身もまた、有限境界 $B_{\text{RDL}}$ によって切り出された一つの有限関係拘束構造 $M_{B,\text{RDL}}$ である**。本辞書の外部には常に未回収関係 $\xi_{\text{RDL}}$ が残存し、より生存可能で頑健な切り分け方が見出されれば、語彙そのものが再編・更新されうる（B5 自己例外化禁止 / Aporapeiron）。
